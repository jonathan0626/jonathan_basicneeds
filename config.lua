...
--補血程度(範圍 0 - 100)  若設定為負值應會導致無作用
--The extent of the blood supplementation(Range from 0.01 to 0.99).
--滿血是100滴 ，假設設定 10 即代表一次回復 100*0.1 = 10滴血
--For example : Suppose you set 10 ，this means you will reply to 10% of the max health.

Config.heal1 = 10 --第一個補血藥品 The first blood-replenishing drug.
Config.heal2 = 50 --第二個補血藥品 The second blood-replenishing drug.
